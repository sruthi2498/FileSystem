CFLAGS=-std=gnu99
all : write_to_log disk syscall dir file initialise main
...
main : main.c main.h all_include.h
	gcc $(CFLAGS) -o main -Wall main.c `pkg-config fuse3 --cflags --libs` write_to_log.o disk.o syscall.o dir.o file.o initialise.o -w
binaries=main initialise dir file syscall disk write_to_log
clean:
	rm -f $(binaries) *.o