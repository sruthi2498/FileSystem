CFLAGS=-std=gnu99
all : write_to_log disk namei syscall dir file initialise
...
initialise : initialise.c initialise.h all_include.h
	gcc $(CFLAGS) -o initialise -Wall initialise.c `pkg-config fuse3 --cflags --libs` write_to_log.o disk.o syscall.o namei.o dir.o file.o -w
binaries=initialise dir file syscall namei disk write_to_log
clean:
	rm -f $(binaries) *.o